...
export const LAYOUT_TEMPLATES: Record<string, LayoutTemplate> = {
  ...
  familyCentral: {
    ...
    widgets: [
      ...
      { i: 'weather', x: 28, y: 6, w: 20, h: 6 },
      { i: 'tasks', x: 28, y: 12, w: 20, h: 6 },
      { i: 'messages', x: 0, y: 18, w: 16, h: 9 },
      { i: 'chores', x: 16, y: 18, w: 16, h: 9 },
      { i: 'birthdays', x: 32, y: 18, w: 16, h: 9 },
    ],
  },
  ...
  taskMaster: {
    ...
    orientation: 'landscape',
    widgets: [
      { i: 'tasks', x: 0, y: 0, w: 24, h: 18 },
      { i: 'chores', x: 24, y: 0, w: 24, h: 18 },
      { i: 'clock', x: 0, y: 18, w: 12, h: 9 },
      { i: 'weather', x: 12, y: 18, w: 12, h: 9 },
      { i: 'calendar', x: 24, y: 18, w: 12, h: 9 },
      { i: 'shopping', x: 36, y: 18, w: 12, h: 9 },
    ],
  },
  ...
  calendarFocus: {
    ...
    widgets: [
      ...
      { i: 'clock', x: 34, y: 0, w: 14, h: 5 },
      { i: 'weather', x: 34, y: 5, w: 14, h: 5 },
      { i: 'tasks', x: 34, y: 10, w: 14, h: 7 },
      { i: 'messages', x: 34, y: 17, w: 14, h: 5 },
  ...
  commandCenter: {
    ...
    widgets: [
      ...
      { i: 'calendar', x: 0, y: 6, w: 24, h: 11 },
      { i: 'tasks', x: 24, y: 6, w: 24, h: 11 },
      { i: 'chores', x: 0, y: 17, w: 16, h: 6 },
      { i: 'shopping', x: 16, y: 17, w: 16, h: 6 },
      { i: 'messages', x: 32, y: 17, w: 16, h: 6 },
      { i: 'meals', x: 0, y: 23, w: 48, h: 4 },
    ],
  },
  ...
  mealPlanner: {
    ...
    widgets: [
      ...
      { i: 'clock', x: 32, y: 0, w: 16, h: 6 },
      { i: 'weather', x: 32, y: 6, w: 16, h: 5 },
      { i: 'calendar', x: 32, y: 11, w: 16, h: 16 },
    ],
  },
  ...
  familyCentralPortrait: {
    ...
    widgets: [
      { i: 'clock', x: 0, y: 0, w: 18, h: 8 },
      { i: 'weather', x: 18, y: 0, w: 18, h: 8 },
      { i: 'calendar', x: 0, y: 8, w: 36, h: 28 },
  ...
  taskMasterPortrait: {
    ...
    widgets: [
      ...
      { i: 'clock', x: 0, y: 36, w: 18, h: 8 },
      { i: 'weather', x: 18, y: 36, w: 18, h: 8 },
      { i: 'shopping', x: 0, y: 44, w: 36, h: 10 },
      { i: 'calendar', x: 0, y: 54, w: 36, h: 10 },
    ],
  },
  ...
  commandCenterPortrait: {
    ...
    orientation: 'portrait',
    widgets: [
      { i: 'clock', x: 0, y: 0, w: 18, h: 7 },
      { i: 'weather', x: 18, y: 0, w: 18, h: 7 },
      { i: 'calendar', x: 0, y: 7, w: 36, h: 16 },
      { i: 'tasks', x: 0, y: 23, w: 18, h: 13 },
      { i: 'messages', x: 18, y: 23, w: 18, h: 13 },
      { i: 'chores', x: 0, y: 36, w: 18, h: 10 },
      { i: 'shopping', x: 18, y: 36, w: 18, h: 10 },
      { i: 'meals', x: 0, y: 46, w: 36, h: 10 },
  ...
  minimalPortrait: {
    ...
    orientation: 'portrait',
    widgets: [
      { i: 'clock', x: 0, y: 0, w: 18, h: 10 },
      { i: 'weather', x: 18, y: 0, w: 18, h: 10 },
      { i: 'calendar', x: 0, y: 10, w: 36, h: 38 },
  ...
  mealPlannerPortrait: {
    ...
    widgets: [
      ...
      { i: 'clock', x: 0, y: 36, w: 18, h: 8 },
      { i: 'weather', x: 18, y: 36, w: 18, h: 8 },
      { i: 'calendar', x: 0, y: 44, w: 18, h: 20 },
      { i: 'tasks', x: 18, y: 44, w: 18, h: 20 },
    ],
  },
};
